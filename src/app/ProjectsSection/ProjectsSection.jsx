...
const projectsData = [
  {
    ...
    description: "A premium eco-commerce platform for plant enthusiasts. Features include plant care guides and environmental awareness modules.",
    image: greenNest,
  ...
  },
  {
    ...
    description: "A dynamic ticketing marketplace with real-time seat selection, admin panel, and secure resale verification system.",   
    image: ticketBooking, 
    liveLink: "https://online-ticket-booking-platform.netlify.app/", 
    githubClient: "https://github.com/sakhawat236hossain/Online-Ticket-Booking-Platform-client-",
    color: "from-rose-500 via-pink-600 to-purple-600"
  },
  {
    title: "Home Nest",
    tags: ["MERN Stack", "Express.js", "Dashboard"],
    description: "High-end Real Estate solution with interactive property listings, secure payments, and a powerful admin control panel.",
    image: homeNest,
  ...
  },
  {
    ...
    description: "An integrated dashboard featuring utility tools and mini-apps, designed with a focus on seamless user navigation.",
    image: AllApps,
  ...
  },
  {
    ...
    description: "A real-time news aggregation platform with category filtering and dynamic content loading for a smooth experience.",
    image: dragonNews,
...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="relative w-full py-24 md:py-32 px-4 md:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="space-y-4">
            ...
            >
              Selected <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500">Works</span>
            </motion.h2>
          </div>
          <motion.p 
            initial={{ opacity: 0 }}
          ...
          >
            Crafting digital experiences where functionality meets aesthetic excellence.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
          <AnimatePresence mode='popLayout'>
            {visibleProjects.map((project, index) => (
              ...
              >
                <div className="relative bg-white dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-[2.5rem] overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 h-full flex flex-col">
                  ...
                  <div className="relative h-72 w-full overflow-hidden">
                    ...
                    {/* Hover Overlay */}
                    <div className={`absolute inset-0 bg-gradient-to-b ${project.color} opacity-0 group-hover:opacity-90 transition-all duration-500 flex items-center justify-center gap-6 backdrop-blur-[4px]`}>
                      <ProjectLink href={project.liveLink} icon={<FaExternalLinkAlt size={20}/>} label="Live Site" />
                      <ProjectLink href={project.githubClient} icon={<FaGithub size={22}/>} label="Source" />
                    </div>

                    {/* Quick Badge */}
                    <div className="absolute top-6 left-6 px-4 py-1.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full">
                        <span className="text-[10px] font-black text-white uppercase tracking-widest">Featured Case</span>
                    </div>
                  </div>
                  ...
                  <div className="p-8 flex-grow space-y-4">
                    <div className="flex flex-wrap gap-2">
                      {project.tags.map(tag => (
                        <span key={tag} className="text-[9px] font-black tracking-widest px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-full uppercase">
                          {tag}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className={`h-2 w-full bg-gradient-to-r ${project.color} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}></div>
                </div>
              </motion.div>
            ))}
          </AnimatePresence>
        ...
        <div className="mt-24 flex justify-center">
          ...
          >
            <span className="relative z-10 uppercase tracking-widest text-xs flex items-center gap-3">
              ...
              <svg className={`w-4 h-4 transition-transform duration-300 ${showAll ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M19 9l-7 7-7-7"></path></svg>
            </span>
