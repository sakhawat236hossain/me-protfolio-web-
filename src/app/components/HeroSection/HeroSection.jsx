...
const HeroSection = () => {
  return (
    <section id="home" className="w-full min-h-screen flex items-center justify-center pt-28 pb-10 md:py-0 overflow-hidden">
      <div className="flex flex-col-reverse md:flex-row items-center justify-between w-[92%] lg:w-[85%] gap-12">
        ...
        <div className="text-center md:text-left w-full md:w-3/5">
          ...
          >
            I specialize in building high-performance, responsive, and visually stunning web applications. 
          ...
          >
            ...
            <Link
              ...
              duration={500}
              offset={-70}
              className="flex items-center gap-2 px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-2xl font-bold shadow-2xl hover:bg-purple-600 dark:hover:bg-purple-600 dark:hover:text-white transition-all active:scale-95 cursor-pointer group"
            >
          ...
          >
            <SocialIcon icon={<AiFillGithub />} link="https://github.com/sakhawat236hossain" />
            <SocialIcon icon={<FaLinkedinIn />} link="https://linkedin.com/in/md-sakhawat-hossain-web-developer/" />
            <SocialIcon icon={<AiFillFacebook />} link="https://facebook.com/md.sakhawth.hosain" />
            <SocialIcon icon={<AiOutlineTwitter />} link="https://x.com/MdSakhawat21005" />
          </motion.div>
        </div>
        ...
        >
          <div className="relative group w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] lg:w-[420px] lg:h-[420px]">
            ...
            {/* Main Image Wrapper */}
            <motion.div 
              className="relative w-full h-full p-3 bg-white dark:bg-slate-800 rounded-[2.5rem] shadow-2xl z-10"
              animate={{ y: [0, -15, 0] }}
            ...
            <div className="absolute -bottom-4 -right-4 bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-xl z-20 border border-slate-100 dark:border-slate-800 hidden sm:block">
               <p className="text-purple-600 font-black text-xl">10+</p>
               <p className="text-[10px] text-slate-500 uppercase font-bold tracking-tighter">Projects Done</p>
            </div>
          </div>
        </motion.div>
