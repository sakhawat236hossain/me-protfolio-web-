      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 md:mb-20">
          ...
          >
            ...
            <span className="text-purple-400 font-bold tracking-widest uppercase text-[10px] md:text-xs">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-8 rounded-3xl border border-slate-800 backdrop-blur-xl">
              <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
                <FaPaperPlane className="text-purple-500 text-sm" /> Social
                Connect
              </h3>
          ...
          <div className="lg:col-span-7">
            <motion.div
              ...
              className="p-6 md:p-10 rounded-[2rem] border border-slate-800 backdrop-blur-3xl shadow-2xl relative"
            >
                ...
                >
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      type="text"
                      required
                      placeholder="Ex: Sakhawat Hossain"
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      type="email"
                      required
                      placeholder="hello@sakhawat.com"
                      className="contact-input"
                    />
                  </div>
                </motion.div>
...
const ContactInfoCard = ({ icon, label, value, link }) => (
  <motion.a
    href={link}
    target="_blank"
    whileHover={{ y: -5, backgroundColor: "rgba(30, 41, 59, 0.3)" }}
    className="group p-5 rounded-2xl border border-slate-800 flex items-center gap-5 transition-all backdrop-blur-sm"
  >
    ...
    <div className="overflow-hidden">
      ...
      <p className="text-sm md:text-base font-bold text-white group-hover:text-purple-400 transition-colors truncate">
        {value}
      </p>
    </div>
  </motion.a>
