...
const About = () => {
  return (
    <section
      id="about"
      className="w-full min-h-screen flex items-center justify-center px-4 sm:px-6 py-20 bg-transparent overflow-hidden"
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        >
          <div className="relative w-[280px] h-[350px] sm:w-[380px] sm:h-[480px]">
            ...
            <div className="absolute -top-6 -left-6 w-full h-full border-2 border-purple-600/30 rounded-3xl -z-10 hidden sm:block"></div>
            <div className="absolute -bottom-6 -right-6 w-full h-full bg-gradient-to-br from-purple-600/20 to-blue-600/20 rounded-3xl -z-10"></div>
            
            {/* Main Image Card */}
            <div className="relative w-full h-full rounded-3xl overflow-hidden shadow-2xl group border-4 border-white dark:border-slate-800">
              <Image
                src={myIMG} 
                alt="About Sakhawat"
                fill
            ...
            >
              <p className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500">1+</p>
        ...
        >
          <div className="inline-block px-4 py-1 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 text-sm font-bold tracking-tighter uppercase mb-4">
            My Biography
          </div>
          
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-8 leading-tight">
            Crafting Digital <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-500">Masterpieces</span>
          </h2>
          
          <div className="space-y-6 text-slate-600 dark:text-slate-400 text-base md:text-lg leading-relaxed">
            <p>
              Hello! I'm <span className="font-bold text-slate-900 dark:text-white">Md Sakhawat Hossain</span>. 
              I am a results-driven Frontend Developer specializing in the MERN stack. My mission is to bridge the gap between complex backend logic and pixel-perfect frontend design.
            </p>
            <p>
              With expertise in <span className="text-purple-600 dark:text-purple-400 font-semibold">Next.js, Tailwind CSS, and Framer Motion</span>, 
              I create interfaces that aren't just functional, but emotionally engaging for the users.
            </p>
          </div>
...
const FeatureBox = ({ icon, title }) => (
  <div className="flex items-center gap-3 p-4 rounded-xl bg-slate-50 dark:bg-slate-800/30 border border-slate-100 dark:border-slate-700/50 hover:border-purple-500/50 transition-colors group">
