...
const skillsData = [
  ...
  {
    name: "Next.js",
    img: "https://img.icons8.com/fluency/96/nextjs.png",
  ...
  {
    name: "Express.js",
    img: "https://img.icons8.com/office/96/express-js.png",
  ...
  {
    name: "Vercel",
    img: "https://img.icons8.com/fluency/96/vercel.png",
    shadow: "shadow-white/10",
  },
  {
    name: "Figma",
    img: "https://img.icons8.com/color/96/figma.png",
    shadow: "shadow-purple-500/20",
  },
  {
    name: "VS Code",
    img: "https://img.icons8.com/fluency/96/visual-studio-code-2019.png",
    shadow: "shadow-blue-600/20",
  },
  {
    name: "npm",
    img: "https://img.icons8.com/color/96/npm.png",
    shadow: "shadow-red-600/20",
  },
  {
    name: "Postman",
    img: "https://img.icons8.com/color/96/postman-api.png",
    shadow: "shadow-orange-600/20",
  },
  {
    name: "REST API",
    img: "https://img.icons8.com/ios-filled/96/api-settings.png",
    shadow: "shadow-slate-400/20",
  },
];
...
const SkillsSection = () => {
  ...
  return (
    <section
      id="skills"
      className="relative w-full py-10 md:py-20 px-4 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center relative mb-20 md:mb-32">
          ...
          >
            Technical{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-500 to-cyan-500 animate-gradient-x">
              Skillset
            </span>
          </motion.h2>
...
const SkillCard = ({ skill }) => (
  ...
  >
    <div
      className={`relative w-28 h-36 md:w-44 md:h-56 flex flex-col items-center justify-center rounded-[2.5rem] backdrop-blur-2xl border border-slate-200 dark:border-white/5 transition-all duration-500 group cursor-pointer shadow-2xl ${skill.shadow} hover:border-purple-500/50`}
    >
      {/* Card Inner Glow */}
